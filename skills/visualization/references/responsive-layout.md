...
For an SVG that cannot scale safely, provide separate wide and compact projections selected with CSS. Both projections must use the same entities, names, statuses, and relationship meanings; they may arrange or aggregate them differently.
