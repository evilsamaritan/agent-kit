...
## Context
<what constraint created this decision; what's known and unknown>
...
<at least two, with reasons for rejection>

## Open questions
<what we deferred and what would trigger revisit>
```

Store under `docs/adr/`. File name: `NNNN-<slug>.md`. Never delete; when superseded, update status + link forward.
